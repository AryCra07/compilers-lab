...
#line 1076 "syntax.tab.c"
    break;

  case 3: /* expr: expr '+' term  */
#line 16 "syntax.y"
                       { yyval = yyvsp[-2] + yyvsp[0] ; printf("\033[01;34m Reduce : E -> E + T\033[0m\n");}
#line 1082 "syntax.tab.c"
    break;

  case 4: /* expr: expr '-' term  */
#line 17 "syntax.y"
                       { yyval = yyvsp[-2] - yyvsp[0] ; printf("\033[01;34m Reduce : E -> E - T\033[0m\n");}
#line 1088 "syntax.tab.c"
    break;

  case 5: /* expr: term  */
#line 18 "syntax.y"
                       { yyval = yyvsp[0] ; printf("\033[01;34m Reduce : E -> T\n");}
#line 1094 "syntax.tab.c"
    break;

  case 6: /* term: term '*' factor  */
#line 20 "syntax.y"
                       { yyval = yyvsp[-2] * yyvsp[0] ; printf("\033[01;34m Reduce : T -> T * F\033[0m\n");}
#line 1100 "syntax.tab.c"
    break;

  case 7: /* term: term '/' factor  */
#line 21 "syntax.y"
                       { yyval = yyvsp[-2] / yyvsp[0] ; printf("\033[01;34m Reduce : T -> T / F\033[0m\n");}
#line 1106 "syntax.tab.c"
    break;

  case 8: /* term: factor  */
#line 22 "syntax.y"
                       { yyval = yyvsp[0] ; printf("\033[01;34m Reduce : T -> F\033[0m\n");}
#line 1112 "syntax.tab.c"
    break;

  case 9: /* factor: '(' expr ')'  */
#line 24 "syntax.y"
                       { yyval = yyvsp[-1] ; printf("\033[01;34m Reduce : F -> (E)\033[0m\n");}
#line 1118 "syntax.tab.c"
    break;

  case 10: /* factor: NUMBER  */
#line 25 "syntax.y"
                       { yyval = yyvsp[0] ; printf("\033[01;34m Reduce : F -> NUMBER\033[0m\n");}
#line 1124 "syntax.tab.c"
    break;


#line 1128 "syntax.tab.c"
